...
Since the period covers all of 2024 and first half of 2025, we split the data into two groups and compare them:
Baseline: 2024 (Jan–Dec)
Comparison: 2025 (Jan–Jun)
This let us check whether some SSIC groups are growing faster in 2025, or whether patterns are stable.
