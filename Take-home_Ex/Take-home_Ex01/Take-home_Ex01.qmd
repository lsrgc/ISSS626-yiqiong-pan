...
L-function test on Downtown Core for wholesale Business took 30 mins to complete, here we zoom into Cecil to see the code prestige effect. 
First we prepare the observation window and compute L-function estimate for Downtown Core.
