---
title: "In-class Exercies 9: Modelling Geographical Accessibility "
author: "Yiqiong PAN"
date: "Nov 08, 2025"
...
The following code imports CHAS KML file downloaded from data.gov.sg.
...
for(power in powers) {
  ...
  hex_res$power <- power
  results[[as.character(power)]] <- hex_res
}
...
ggplot(hexagon_Hansen_all, aes(x = factor(power), y = accHansen)) +
  geom_boxplot() +
  scale_y_log10() +
