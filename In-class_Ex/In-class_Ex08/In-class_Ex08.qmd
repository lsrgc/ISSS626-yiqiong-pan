...
### Data Sampling
Calibrating predictive models are computaional intensive, especailly random forest method is used. FOr quick prototyping, 1 10% sample will be selected at random from the data.
The code chunk below samples 1500 observations. 
