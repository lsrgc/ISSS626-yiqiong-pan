...
**EHSA Four steps:** - Build a space–time cube. - Calculate local Gi*. - Evaluate the hot/cold-spot trend using the Mann–Kendall test. - Categorise each study-area location by combining the trend (MK z-score and p-value) with the - per-bin hot/cold status (Gi* z-score and p-value).
...
[Mann–Kendall](https://vsp.pnnl.gov/help/vsample/design_trend_mann_kendall.htm) (MK) is a non-parametric trend test: H₀: no monotonic trend (flat). H₁: a monotonic trend exists (consistently increases or decreases).

### Interpreting Kendall’s

τ ranges from −1 to +1 (direction = sign; strength = magnitude). In Kendall::MannKendall, sl is the p-value.
...
The code chunk below generates the EHSA statisitics for each region.
...
pal <- c("Insignificant" = "grey80", other_cols)
...
![](img/Screenshot 2025-09-29 234329.png)

![](img/Screenshot 2025-09-29 234337.png)

![](img/Screenshot 2025-09-29 234344.png)

![](img/Screenshot 2025-09-29 234351.png)
