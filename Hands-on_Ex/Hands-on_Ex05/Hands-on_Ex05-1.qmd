...
The Moran's I statistics could be conducted by using [`moran.test()`](https://r-spatial.github.io/spdep/reference/moran.test.html) from **spdep** package. Global Moran's I measures how the features **differ from the values in the study area as a whole**,from -1 to 1, similar with Persons'r (**correlation coefficient**).
