...
The code chunk below changes Coordinate Reference System (from user input WGS 84 to projected CRS UTM zone 50N) by using `st_transform()` and assigning CRS 32650. After this transformation, we no longer need to include longlat = TRUE at the following steps.
