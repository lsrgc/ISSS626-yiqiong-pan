...
For detecting **outliers and local clusters**, we use **LISA (Local Moran’s I)** with **distance-based** or **contiguity-based** weights matrix.
For identifying **hot spots and cold spots**, we use **Getis-Ord Local Gi\***, only with a **distance-based weights matrix**.
...
-   
    ...
    Common cut-offs: 0.05, 0.01, 0.001.
