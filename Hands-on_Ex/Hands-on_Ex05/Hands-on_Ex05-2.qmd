...
tmap_arrange(equal, lisa_map,quantile, lisa_map,ii.map,lisa_map,  asp=1, ncol=2)
```
::: callout-note
**What statistical conclusion can you drawfrom the LISA map above?**

At the 95% confidence level, the LISA map shows the eastern–central regions around **Chengdu** form clustered wealthy areas, while the western–southern county of **Wugang** is identified as a least wealthy area.
:::
