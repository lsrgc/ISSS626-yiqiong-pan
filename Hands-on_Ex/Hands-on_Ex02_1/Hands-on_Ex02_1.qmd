...
KDE results show that childcare distribution patterns differ across planning areas from highly concentrated hubs (Tampines) to more dispersed clusters (Punggol, Jurong West). However further analysis with population and residential data is needed to assess alignment with demand.
