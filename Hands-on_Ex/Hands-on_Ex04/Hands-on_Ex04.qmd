...
*It is based on total value of of all neighours, not an average. e.g. region 1's sum would be 5  x average value = 124326*
...
- Including the diagonal blends self and neighbours, producing a more conservative view.
